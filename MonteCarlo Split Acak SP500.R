...
output_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Simulated_Return_SP500_8020.xlsx"
...
input_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Simulated_Return_SP500_8020.xlsx"
...
S0_call <- 4967.22998  # Harga aset di tgl 2024-4-19 (baris terakhir data pelatihan)
...
# Tentukan path untuk menyimpan file
output_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Pricepath_SP500_8020.xlsx"
...
plot(1:63, price_paths[1, 1:63], type = "l", col = "blue", ylim = range(price_paths[, 1:63]), 
     xlab = "Hari", ylab = "Harga S&P500", main = "Simulasi Jalur Harga S&P500 (63 Hari Terakhir)")
# Tambahkan jalur harga lain ke plot
for (sim in 2:10000) {  # Misalnya, plotkan 200 jalur simulasi pertama
  lines(1:63, price_paths[sim, 1:63], col = sample(colors(), 1))
}
...
library(writexl)
file_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Results MC/80:20/Hasil MC8020 SP500.xlsx"
...
output_call_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Kumpulan_Price_SP500_8020.xlsx"
...
input_call_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Kumpulan_Price_SP500_8020.xlsx"
...
output_average_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Average_Prices_SP500_8020.xlsx"
...
output_normality_results_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Normality_Results_SP500_8020.xlsx"
...
output_ci_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Confidence_Intervals_Per_Day_SP500_8020.xlsx"
...
output_put_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Kumpulan_PricePUT_SP500_8020.xlsx"
...
input_put_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Kumpulan_PricePUT_SP500_8020.xlsx"
...
output_average_prices_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Average_PricesPUT_SP500_8020.xlsx"
write_xlsx(list("Average Prices" = average_prices_per_group), path = output_average_prices_path)
cat("Rata-rata harga per grup telah disimpan ke:", output_average_prices_path, "\n")
...
# Simpan hasil uji normalitas ke Excel
output_normality_results_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Normality_Results_PUT_SP500_8020.xlsx"
write_xlsx(list("Normality Results" = normality_results), path = output_normality_results_path)
...
# Simpan hasil confidence interval ke file Excel
output_ci_path <- "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/Confidence_Intervals_PUT_Per_Day_SP500_8020.xlsx"
write_xlsx(list("Confidence Intervals" = confidence_intervals_per_day), path = output_ci_path)
cat("Confidence intervals per day telah disimpan ke:", output_ci_path, "\n")
...
price_data <- read_excel("/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/SP8020/Kumpulan_Price_SP500_8020.xlsx")
...
write.xlsx(quantile_df, "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/SP8020/Percentile_SPCall_8020.xlsx")
...
priceput_data <- read_excel("/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/SP8020/Kumpulan_PricePUT_SP500_8020.xlsx")
...
# 6. Simpan hasil ke file Excel baru
write.xlsx(quantileput_df, "/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/SP8020/Percentile_SPPut_8020.xlsx")
...
pricepath_data <- read_excel('/Users/shannenwibisono/Desktop/-SKRIPSI-/Monte Carlo/SP8020/Pricepath_SP500_8020.xlsx')
